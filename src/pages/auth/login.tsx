...
const LoginPage = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center bg-gray-900 text-white overflow-hidden">
      <div className="auth-background w-full">
        <Image
      ...
      <div className="auth-container max-w-2xl mx-auto p-8 mt-16 bg-gray-800/70 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-4 text-white">Welcome Back!</h1>
        <p className="text-lg mb-6 text-gray-300">Log in to continue your journey</p>
